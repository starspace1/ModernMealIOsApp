...
class ViewController: UIViewController {
  ...
  @IBAction func signupBtnTapped(sender: AnyObject) {
    ...
    if self.signupNameTextField.text.characters.count > 0 && self.signupEmailTextField.text.characters.count > 0
      && self.signupPasswordTextField.text.characters.count > 0 {
  ...
  @IBAction func signinBtnTapped(sender: AnyObject) {
    ...
    if self.signinEmailTextField.text.characters.count > 0 &&
      self.signinPasswordTextField.text.characters.count > 0 {
